...
if sys.platform == "win32":  # pragma: win32 cover
    ...
    class UnixFileLock(BaseFileLock):
        ...
        def _fallback_to_soft_lock(self) -> None:
            ...
            warnings.warn(
                "flock not supported on this filesystem, falling back to SoftFileLock", stacklevel=2
            )
            from .asyncio import AsyncSoftFileLock, BaseAsyncFileLock  # noqa: PLC0415

            self.__class__ = (
                AsyncSoftFileLock if isinstance(self, BaseAsyncFileLock) else SoftFileLock
            )
